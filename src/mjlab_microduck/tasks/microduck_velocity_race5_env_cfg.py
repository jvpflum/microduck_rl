...
def make_microduck_velocity_race5_env_cfg(
    ...
    cfg.rewards["race_lane_error"].weight = -45.0
    cfg.rewards["race_lane_error"].params["lane_half_width_m"] = 0.25
    ...
    cfg.rewards["race_invalid_heat"] = RewardTermCfg(
        ...
        weight=-750.0,
        params={"lane_half_width_m": 0.30, "maximum_yaw_rad": 0.436332},
    )
    cfg.rewards["heading_hold"].weight = 24.0
    cfg.rewards["heading_hold"].params["std"] = 0.10
    cfg.rewards["lateral_speed"].weight = -10.0
